...
```{r}
out <- count_common_slots(n_colleagues = n_colleagues,
                          o = 7,
                          p = 3,
                          dep = .5,
                          p_sd = 0)
...
```{r}
out2 <- count_common_slots(n_colleagues = n_colleagues,
                          o = 7,
                          p = 3,
                          dep = .5,
                          p_sd = 1)
...
```{r pop-grid3a, cache=TRUE, eval = FALSE}
tic()
...
```{r pop-grid3b, cache=TRUE, eval = FALSE}
tic()
